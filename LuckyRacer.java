...
public class LuckyRacer
{
  public static void main (String args[])
  {
	...
	System.out.printf ("\nCar 1 is %s %s", car1.getModel() , car1.getYear ());
	System.out.printf ("\nCar 2 is %s %s", car2.getModel() , car2.getYear ());
    System.out.printf ("\nCar 3 is %s %s", car3.getModel() , car3.getYear ());
	System.out.printf ("\nCar 4 is %s %s", car4.getModel() , car4.getYear ());
	System.out.printf ("\nCar 5 is %s %s", car5.getModel() , car5.getYear ());
	...
	for(int i=0;i<10;i++){
		...
		System.out.printf ("\n%s %s at speed %d" , car1.getModel() , car1.getYear () , TotalSpeedCar1 );
		...
		System.out.printf ("\n%s %s at speed %d" , car2.getModel() , car2.getYear () , TotalSpeedCar2 );
	    g = car2.distance/100;
		for (int f = 0; f<=g;f++)
		{
		 System.out.printf ("-");
		...
		System.out.printf ("\n%s %s at speed %d" , car3.getModel() , car3.getYear () , TotalSpeedCar3 );
		g = car3.distance/100;
		for (int f = 0; f<=g;f++)
		{
		 System.out.printf ("-");
		...
		System.out.printf ("\n%s %s at speed %d" , car4.getModel() , car4.getYear () , TotalSpeedCar4 );
		g = car4.distance/100;
		for (int f = 0; f<=g;f++)
		{
		 System.out.printf ("-");
		...
		System.out.printf ("\n%s %s at speed %d" , car5.getModel() , car5.getYear () , TotalSpeedCar5 );
		g = car5.distance/100;
		for (int f = 0; f<=g;f++)
		{
		 System.out.printf ("-");
